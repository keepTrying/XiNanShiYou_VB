...
Begin VB.Form frmHEENTnew_ResultInput 
   Caption         =   "五官科结果录入窗口"
   ClientHeight    =   10230
   ClientLeft      =   60
   ClientTop       =   345
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TabDlg.SSTab ctabPerson 
            ...
            EndProperty
            TabCaption(0)   =   "   单个处理  "
            TabPicture(0)   =   "frmHEENTnew_ResultInput.frx":0000
            ...
            TabCaption(1)   =   "   批量处理 "
            TabPicture(1)   =   "frmHEENTnew_ResultInput.frx":001C
   ...
   End
End
Attribute VB_Name = "frmHEENTnew_ResultInput"
...
'    On Error Resume Next
    ...
    If ccmbHistory.Text <> "——" Then
        ...
        Set lobjRec = mobj体检医师.func获取指定年份的体检病历(Trim(ctxtSingleNo.Text), ccmbHistory.Text, "五官科")
...
'            cgrdInput.Height = cgrdInput.Height - 300
            ...
            Set lobjRec = mobj体检医师.func获取指定年份的体检病历结论(Trim(ctxtSingleNo.Text), "01", Trim(ccmbHistory.Text))
            If Not lobjRec Is Nothing Then
...
Private Sub subShowSinglePerson()
    ...
    If lstrNo <> "" Then
        ...
        If ctabPerson.Tab = 0 Then
            ...
            Set lobjDatecobo = mobj体检医师.func获取体检人员的体检病历(Trim(ctxtSingleNo.Text), "五官科")
...
'            Next
    ...
    Case "退出"
        ...
        End If
        Unload Me
        Set frmHEENTnew_ResultInput = Nothing
    '2012-06-21 于登淼 ↑
    End Select
    Exit Sub
...
Private Sub subSaveBatch()
    ...
    For i = 1 To barCode.Count
        isOk = lobjTmp.func保存单人体检结果(barCode(i), um用户名, DTP录入日期.Value, lcolItem, lcolResult, "职业病体检_结果信息_五官科")
...
Private Function sub是否有画图项目(ByVal paraSysNo As String) As Boolean
    ...
    Set lcol职业病对象 = CreateObject("职业病体检结果录入.clsCommon")
    lstrItemNo = lcol职业病对象.func获取体检项目编号(mstr结果图片名称)
    strSQL = "select * from 职业病体检_结果信息_五官科 where 系统编号='" & paraSysNo & "' and 体检项目='" & lstrItemNo & "'"
    Set lobjRec = dafuncGetData(strSQL)
