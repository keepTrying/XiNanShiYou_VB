   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TabDlg.SSTab SSTPersonalInfo 
            ...
            Tab(1).Control(0)=   "ccrp进度"
            Tab(1).Control(1)=   "fraQueryBatch"
            Tab(1).Control(2)=   "Timerccrp"
            Tab(1).Control(3)=   "ccmdSelInfo"
            Tab(1).Control(4)=   "cchkCompanyBatch"
            Tab(1).Control(5)=   "ctxtQueyCompanyBatch"
            Tab(1).Control(6)=   "ccmd查询单位"
            ...
            Tab(1).Control(14)=   "TotalPeopleBatch"
