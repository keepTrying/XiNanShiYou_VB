...
Begin VB.Form frmChromosome_ResultInput 
   Caption         =   "染色体化验科结果录入窗口"
   ClientHeight    =   10230
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   13365
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin TabDlg.SSTab ctabPerson 
            ...
            EndProperty
            TabCaption(0)   =   "   单个处理  "
            TabPicture(0)   =   "frmChromosome_ResultInput.frx":0000
            ...
            TabCaption(1)   =   "   批量处理 "
            TabPicture(1)   =   "frmChromosome_ResultInput.frx":001C
   ...
   End
End
Attribute VB_Name = "frmChromosome_ResultInput"
...
'    On Error Resume Next
    ...
    If ccmbHistory.Text <> "——" Then
        ...
        Set lobjRec = mobj体检医师.func获取指定年份的体检病历(Trim(ctxtSingleNo.Text), ccmbHistory.Text, "染色体化验科")
...
'            cgrdInput.Height = cgrdInput.Height - 300
            ...
            Set lobjRec = mobj体检医师.func获取指定年份的体检病历结论(Trim(ctxtSingleNo.Text), "07", Trim(ccmbHistory.Text))
...
'''    ctxtSingleNo.Text = mstr系统编号固定部分
    ...
    If lobjTmp.func科室操作权限(um用户编号, "职业病体检_染色体化验科结果录入_修改") = False Then
        ctbMain.Buttons(2).Visible = False
    End If
    
    If lobjTmp.func科室操作权限(um用户编号, "职业病体检_染色体化验科结果录入_批量修改") = False Then
...
Private Sub subShowSinglePerson()
    ...
    If lstrNo <> "" Then
        ...
        If ctabPerson.Tab = 0 Then
            ...
            Set lobjDatecobo = mobj体检医师.func获取体检人员的体检病历(Trim(ctxtSingleNo.Text), "染色体化验科")
...
'            Next
    ...
    Case "退出"
        ...
        End If
        Unload Me
        Set frmChromosome_ResultInput = Nothing
    '2012-06-21 于登淼 ↑
    End Select
    Exit Sub
...
Private Sub subSaveBatch()
    ...
    For i = 1 To barCode.Count
        isOk = lobjTmp.func保存单人体检结果(barCode(i), um用户名, DTP录入日期.Value, lcolItem, lcolResult, "职业病体检_结果信息_染色体化验科")
