...
Private Sub ccmdOk_Click()
    ...
    Exit Sub
errHandler:
    sfsub错误处理 "职业病史录入界面", "frmquery", "ccmdok_click", Err.Number, Err.Description, True
End Sub
...
Private Sub ccmd定位_Click()
    ...
    Exit Sub
errHandler:
    sfsub错误处理 "职业病史录入界面", "frmquery", "ccmd定位_click", Err.Number, Err.Description, True
End Sub
...
Private Sub Form_Load()
    ...
    Exit Sub
errHandler:
    sfsub错误处理 "职业病史录入界面", "frmquery", "form_load", Err.Number, Err.Description, True
End Sub
