...
Begin VB.Form FrmRegisterAgain 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "基本信息录入            "
      TabPicture(0)   =   "FrmRegisterAgain.frx":0442
      ...
      Tab(0).Control(34)=   "Check1"
      Tab(0).Control(34).Enabled=   0   'False
      Tab(0).Control(35)=   "Com上传"
      ...
      Begin VB.Frame Frame5 
         ...
         Top             =   480
         Width           =   3255
         Begin VB.TextBox ctxtRecheckItem 
            Enabled         =   0   'False
            Height          =   615
            Left            =   0
            MultiLine       =   -1  'True
      ...
      Begin VB.Frame Frame4 
         ...
         Top             =   480
         Width           =   3135
         Begin VB.TextBox ctxtRecheckReason 
            Enabled         =   0   'False
            Height          =   615
            Left            =   0
            MultiLine       =   -1  'True
      ...
      Begin VB.ComboBox ccmb体检类别 
         Height          =   300
         ItemData        =   "FrmRegisterAgain.frx":045E
         Left            =   8640
         List            =   "FrmRegisterAgain.frx":0465
         Style           =   2  'Dropdown List
         TabIndex        =   23
         Top             =   360
         Visible         =   0   'False
...
'        cdtpDate.Value = IIf(IsNull(lobjRec!建档日期), "", lobjRec!建档日期)
        ...
        '2013-03-04 刘云乐
        '新增 复查原因，复查项目
        ctxtRecheckReason.Text = IIf(IsNull(lobjRec!复查原因), "", lobjRec!复查原因)
        ctxtRecheckItem.Text = IIf(IsNull(lobjRec!复查项目), "", lobjRec!复查项目)
        '2013-03-04 刘云乐
        '获取像片
...
Private Sub mobjGUI_BeforeOperate(ByVal Operate As String, Cancel As Boolean)
    ...
    Case "保存"
        ...
        If Check1.Value = 0 Then
            sub复查保存
            pobj业务对象.func写入单人当前体检状态 pstr复查系统编号, 4
            Unload Me
            Exit Sub
        Else
            '2012-12-18 刘云乐
            ...
            If 访问标志 = 2 Then
                ...
                DoEvents
                pobj业务对象.func写入单人当前体检状态 pstr复查系统编号, 2
