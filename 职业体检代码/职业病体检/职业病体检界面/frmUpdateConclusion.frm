...
errHandler:
    ...
    sfsub错误处理 "职业病界面部件", "frmUpdateConclusion", "clstSelectedConclusion_Click", 6666, lstrError, False
End Sub
...
errHandler:
    Dim lstrError As String
    lstrError = func错误处理(Err.Number, Err.Description)
    sfsub错误处理 "职业病界面部件", "frmUpdateConclusion", "Property Let 系统编号", 6666, lstrError, True
End Property
...
errHandler:
    Dim lstrError As String
    lstrError = func错误处理(Err.Number, Err.Description)
    sfsub错误处理 "职业病界面部件", "frmUpdateConclusion", "Property Let 体检结论", 6666, lstrError, True
End Property
...
errHandler:
    Dim lstrError As String
    lstrError = func错误处理(Err.Number, Err.Description)
    sfsub错误处理 "职业病界面部件", "frmUpdateConclusion", "Property Let 复查体检表名", 6666, lstrError, True
End Property
...
errHandler:
    Dim lstrError As String
    lstrError = func错误处理(Err.Number, Err.Description)
    sfsub错误处理 "职业病界面部件", "frmUpdateConclusion", "ccmdAdd_Click", 6666, lstrError, False
End Sub
...
errHandler:
    Dim lstrError As String
    lstrError = func错误处理(Err.Number, Err.Description)
    sfsub错误处理 "职业病界面部件", "frmUpdateConclusion", "ccmdDel_Click", 6666, lstrError, False
End Sub
...
errHandler:
    Dim lstrError As String
    lstrError = func错误处理(Err.Number, Err.Description)
    sfsub错误处理 "职业病界面部件", "frmUpdateConclusion", "ccmdOK_Click", 6666, lstrError, False
End Sub
