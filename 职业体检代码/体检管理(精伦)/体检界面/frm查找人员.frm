...
Private Sub ccmdOk_Click()
    ...
    Else
        '创建体检集对象。
        Set lobj体检集 = CreateObject("体检对象.clsMedicalExamSet")
        lobj体检集.subClear
...
errHandler:
    ...
    sfsub错误处理 "体检界面部件", "frm查找人员", "ccmdOk_Click", 6666, lstrError, False
...
Private Sub coptChoise_Click(Index As Integer)
    ...
    Exit Sub
errHandler:
    'sfsub错误处理 "体检界面部件", "frm查找人员", "coptChoise_Click", Err.Number, Err.Description, False
End Sub
...
errHandler:
    Dim lstrError As String
    lstrError = func错误处理(Err.Number, Err.Description)
    sfsub错误处理 "体检界面部件", "frm查找人员", "ccmdLocateUnit_Click", 6666, lstrError, False
End Sub
...
Private Function func根据健康档案编号获取系统编号(ByVal para健康档案编号 As String) As String
    ...
    '获取该人最近一次体检记录。
    '创建体检人员对象。
    Set lobj体检人员 = CreateObject("体检对象.clsPersonExamed")
